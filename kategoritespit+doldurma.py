...
def mukerrerno_doldur():
  ...
  print('Muk_no Toplam Hata:', sum(kategoridekiHataliBelgeSayisi))
  print("Muk_no Başarı oranı: ", (4142 - sum(kategoridekiHataliBelgeSayisi)) / 4142)
...
def maddesay_doldur():
  ...
  print('MaddeSay Toplam Hata:', sum(kategoridekiHataliBelgeSayisi))
  print("MaddeSay Başarı oranı: ", (4142 - sum(kategoridekiHataliBelgeSayisi)) / 4142)
...
for satir in range(satirToplami):
  ...
  try:
    if cikti == 'Cumhurbaşkanlığı Kararnamesi':
      if cumhurbaskank_doldur(satir):
        doldur_dogru += 1
      else:
        doldur_yanlis += 1

    elif cikti == 'Resmi Gazete':
      if gazete_doldur(satir):
        doldur_dogru += 1
      else:
        doldur_yanlis += 1
    elif cikti == 'Tüzük':
      if tuzuk_doldur(satir):
        doldur_dogru += 1
      else:
        doldur_yanlis += 1
      ...
      print ("pain")
      if komisyonraporu_doldur(satir):
        doldur_dogru += 1
      else:
        doldur_yanlis += 1

    elif cikti == 'Genelge':
      if genelge_doldur(satir):
        doldur_dogru += 1
      else:
        doldur_yanlis += 1

    elif cikti == 'Yönetmelik':
      if yonetmelik_doldur(satir):
        doldur_dogru += 1
      else:
        doldur_yanlis += 1

    elif cikti == 'Tebliğ':
      if teblig_doldur(satir):
        doldur_dogru += 1
      else:
        doldur_yanlis += 1
...
#print("veridoldur d-y :", doldur_dogru, doldur_yanlis)
print("VeriDoldur Toplam Hata:", doldur_yanlis, "İşlenen miktar:", doldur_dogru+doldur_yanlis)
print("VeriDoldur Başarı Oranı:" , doldur_dogru/(doldur_dogru+doldur_yanlis))
